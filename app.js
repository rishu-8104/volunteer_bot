...
// Slack endpoints - properly configured for HTTP mode
expressApp.use('/slack/events', (req, res) => {
  app.receiver.requestHandler(req, res);
});

expressApp.use('/slack/interactive', (req, res) => {
  app.receiver.requestHandler(req, res);
});

expressApp.use('/slack/commands', (req, res) => {
  app.receiver.requestHandler(req, res);
});
...
expressApp.listen(PORT, () => {
  console.log(`⚡️ CommuBot is running on port ${PORT}!`);
